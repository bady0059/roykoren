...
def half_handshake_attack(scanner, interface, router, gui, passwd_file_name):
    ...
    crack = Crack()
    password = crack.run(interface, router, devices, spoofer, passwd_file_name, gui) 
...
if __name__ == "__main__":
    ...
    #router = Router("28:ee:52:60:9a:f3", 10, "CyberExclusive5Stars")
